                    ...
                    <ul class="media-list chat-list">
                        <li class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" alt="Generic placeholder image" src="/static/theme/cloud/img/chat/headshot1.jpg">
                            </a>
                        ...
                        <li class="media">
                            <a class="pull-right" href="#">
                                <img class="media-object"  alt="Generic placeholder image" src="/static/theme/cloud/img/chat/headshot2.jpg">
                            </a>
                        ...
                        <li class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object"  alt="Generic placeholder image" src="/static/theme/cloud/img/chat/headshot3.jpg">
                            </a>
                            <div class="media-body chat-pop">
                        ...
                        <li class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object"  alt="Generic placeholder image" src="/static/theme/cloud/img/chat/headshot5.jpg">
                            </a>
                            <div class="media-body chat-pop">
                        ...
                        <li class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object"  alt="Generic placeholder image" src="/static/theme/cloud/img/chat/headshot4.jpg">
                            </a>
                            <div class="media-body chat-pop">
