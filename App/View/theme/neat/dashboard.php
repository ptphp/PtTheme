			...
			<div class="row-fluid no-margin">
				<div class="span12">
							...
							<ul class="quicktasks">
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/order-149.png" alt="">
										<span>Check orders</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/calendar.png" alt="">
										<span>Upcoming events</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/basket.png" alt="">
										<span>New product</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/communication.png" alt="">
										<span>Support tickets</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/hire-me.png" alt="">
										<span>Approve user</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/full-time.png" alt="">
										<span>Manage cronjobs</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/invoice.png" alt="">
										<span>Invoices</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/bank.png" alt="">
										<span>Balance</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/statistics.png" alt="">
								...
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/bestseller.png" alt="">
										<span>Bestseller</span>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="/static/theme/neat/img/icons/essen/32/config.png" alt="">
								...
								<ul>
									<li class="dropdown">
										...
										<ul class="dropdown-menu pull-right custom">
											...
											<li>
												<a href="#" class='fugue'><img src="/static/theme/neat/img/icons/fugue/bin-metal.png" alt=""> Delete chart</a>
											</li>
										</ul>
									</li>
									<li>
										...
										<td class='actions'>
											<div class="btn-group">
												<a href="#" class='btn btn-mini tip' title="Show details">
													<img src="/static/theme/neat/img/icons/fugue/magnifier.png" alt="">
												</a>
												<a href="#" class='btn btn-mini tip animateRow' data-target=".pendingContainer" data-user='1' data-date='3' data-title='2' title="Mark as pending">
													<img src="/static/theme/neat/img/icons/fugue/document-task.png" alt="">
												</a>
												<a href="#" class='btn btn-mini tip deleteRow' title="Remove">
													<img src="/static/theme/neat/img/icons/fugue/cross.png" alt="">
												</a>
											</div>
										</td>
									</tr>
				...
				<div class="span9">
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<ul class="gallery">
								<li>
									<a href="/static/theme/neat/img/sample/500.gif" class="fancy"><img src="/static/theme/neat/img/sample/60.gif" alt=""></a>
								</li>
								<li>
									<a href="/static/theme/neat/img/sample/500.gif" class="fancy"><img src="/static/theme/neat/img/sample/60.gif" alt=""></a>
								</li>
					...
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<ul class="gallery gallery-detail">
								<li>
									<a href="/static/theme/neat/img/sample/500.gif" class="fancy"><img src="/static/theme/neat/img/sample/100.gif" alt=""></a>
									<div class="info">
										<span>100 KB</span>
